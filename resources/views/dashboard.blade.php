...
<body>
    ...
    <div class="contain">
          ...
          <ul>
                 ...
                 <a>
                      ...
                      <div class="sub-menu2">
                          <div class="sub-container">
                            <div class="sub-2 sub "><a href="/addteacher"><p>Add teacher</p></a></div>
              ...
              <li>
                  <a>
                      ...
                      <div class="sub-menu3">
                          <div class="sub-container">
                              <div class="sub-3 sub"><a href="/addclass"><p>addclass</p></a></div>
              ...
              <li>
                 <a>
                  ...
                  <div class="sub-menu4">
                      <div class="sub-container">
                          <div class="sub-4 sub"><a href="/addstudent"><p>add student</p></a></div>
        ...
        <div class="main">
          ...
          <!--Section for four models displaying information on the dashboard-->
              <div class="main-info">

                  <div class="model">
                      <div class="wrap-content">
                          <div class="conten-model">Total student</div>
                          <span>23000</span>
                      </div>
                      <span class="sub-icon"><i class="fa fa-graduation-cap" aria-hidden="true"></i></span>
                  </div>

                  <div class="model">
                     <div class="wrap-content">
                          <div class="conten-model">Total staffs</div>
                          <span>400</span>
                     </div>
                      <span class="sub-icon-1"><i class="fa fa-users" aria-hidden="true"></i></span>
                  </div>

                  <div class="model">
                     <div class="wrap-content">
                          <div class="conten-model">Department</div>
                          <span>3</span>
                     </div>
                      <span class="sub-icon-2"><i class="fa fa-university" aria-hidden="true"></i></span>
                  </div>

                 
                  <div class="model">
                      <div class="conten-model"></div>
                      <span>part of icon</span>
                      <div class="addition">addition</div>
                  </div>

              </div>
              <!--end of four models control-->



          <!--Section for graph control-->
          ...
          <div class="graph">
            ...
            <div class="graph1">
                <div id="piechart_3d" style="width: 430px ; height:270px"></div>
            </div>
            <div class="graph1">
                <div id="chart_div" style="width: 430px ; height:270px"></div>
            </div>
            <div class="graph1">
                <button id="change-chart">Change to Classic</button>
                <div id="chart_div_line" style="width: 430px ; height:270px"></div>
                
            </div>
            <div class="graph1">
                <div id="chart_organize" style="width: 430px ; height:270px"></div>
            </div>
            <div class="graph1">
    ...
    <script>   
        ...
        function activeLink(){
            list.forEach(item=>{
                ...
                item.classList.remove('hoved')
                this.classList.add('hoved');
                $(this).css("color","red");
        ...
        all_link.forEach(linked => {
                linked.addEventListener("mouseleav",addIcon);    
        })
