...
<body>
          ...
          <ul>
                 ...
                 <a>
                      ...
                      <div class="sub-menu2">
                          <div class="sub-container">
                            ...
                            <div class="sub-2 sub "><a href="/viewteacher"><p class="{{'viewteacher'==request()->path() ? 'fixedLink' : '';}}">View teacher</p></a></div>
              ...
              <li>
                  <a>
                      ...
                      <div class="sub-menu3">
                          <div class="sub-container">
                              <div class="sub-3 sub"><a href="/addclass"><p >add class</p></a></div>
                              <div class="sub-3 sub"><a href=""><p>sub-menu-3</p></a></div>
                 ...
                 <a>
                  ...
                  <div class="sub-menu4">
                      <div class="sub-container">
                          ...
                          <div class="sub-4 sub"><a href="/viewstudent"><p class="{{'viewstudent'==request()->path() ? 'fixedLink' : '';}}">view student</p></a></div>
    ...
    <script>   
        $(window).ready(function(){
            ...
            $('.ro1').toggleClass("rotate");
            $(".sub-menu2").slideDown(300);
